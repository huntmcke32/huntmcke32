...
int main() {
   ...
   const int LRG_PIZZA_FEEDS = 7; // how many people a large pizza feeds
   const int MED_PIZZA_FEEDS = 3; // how many people a medium pizza feeds
   const int SMALL_PIZZA_FEEDS = 1; // how many people a small pizza feeds
   const int LARGE_DIAMETER = 20; // large pizza's diameter
   const int MED_DIAMETER = 16; // medium pizza's diameter
   const int SMALL_DIAMETER = 12; // small pizza's diameter
   ...
   const double LARGE_PRICE = 14.68; // constant value of large pizza cost
   const double MED_PRICE = 11.48;  // constant value of medium pizza cost
   const double SMALL_PRICE = 7.28; // constant value of small pizza cost
